...
//Our clients/My experince - Swiper
var swiper = new Swiper(".experience-swiper", {
    slidesPerView: 1,
    spaceBetween: 30,
    loop: true,
    pagination: {
...
//Navigation meny items active on page scroll
...
//Taget elemts, and specify options to create reveal animations
...
ScrollReveal().reveal('.skill-description, service-description, .contact-card, .experience-swiper, contact-left h2', { delay: 700, origin: 'left'});
